...
class TestSlider:
    def test_slider(self, selenium):
        ...
        selenium.find_element(By.XPATH, '(//*[contains\
        ...
        selenium.find_element(By.XPATH, '//*[@id="#app"]/main/div[1]/div[2]/div/div[1]/div[1]/div[6]/button').click()
        selenium.find_element(By.XPATH, '(//*[contains(@class, "filter-checkboxes-list__value")])[28]').click()
        pass
